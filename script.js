/**
 * AI Code Studio Pro - Fixed Working Implementation
    ...
    updateTabs() {
        ...
        Array.from(this.openTabs).forEach(filePath => {
            ...
            tab.innerHTML = `
                ...
                <button class="tab-close" onclick="event.stopPropagation(); window.codeStudio.closeTab('${filePath}')" title="Close">
...
User question: ${message}`;
            ...
            return `
                <div class="code-block">
                    <div class="code-block-header">
                        ...
                        <button class="copy-code-btn" onclick="window.codeStudio.copyCodeBlock(this)">
    ...
    setupHeaderEventListeners() {
        const buttons = [
            { id: 'newProjectBtn', handler: () => this.createNewProject() },
            { id: 'saveProjectBtn', handler: () => this.saveFile() },
            { id: 'runCodeBtn', handler: () => this.runCode() },
            { id: 'settingsBtn', handler: () => this.showModal('settingsModal') },
    ...
    setupModalEventListeners() {
        ...
        // New file modal specific
        this.setupNewFileModalEventListeners();
    }
    ...
    setupNewFileModalEventListeners() {
...
console.log('Script loaded, initializing AI Code Studio Pro...');
...
window.addEventListener('error', (event) => {
    ...
    if (window.codeStudio) {
        window.codeStudio.showNotification('An unexpected error occurred', 'error');
    }
});
...
window.addEventListener('unhandledrejection', (event) => {
    ...
    if (window.codeStudio) {
        window.codeStudio.showNotification('An error occurred with AI request', 'error');
    }
});

console.log('AI Code Studio Pro script ready!');
